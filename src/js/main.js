/* Author(a): Oscar Eduardo Lopez Barona
   Date of Creation: 16 February 2022
   Last Modificacion: 21 April 2022 */
...
function initScene() {
   ...
   /* var geometry = new THREE.PlaneGeometry(100, 100, 1, 1);
    var material = new THREE.MeshBasicMaterial({color: 0xB90000});
    var floor = new THREE.Mesh(geometry, material);
    floor.material.side = THREE.DoubleSide;
    floor.rotation.x = Mesh.PI / 2;
    scene.add(floor); */
}

function creatFronter(){
    var cubeGreometry = new THREE.cubeGreometry(50,50,50,1,1,1,);
